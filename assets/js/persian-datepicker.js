...
var Config = {
  ...
  'yearPicker': {
    ...
    'titleFormatter': function titleFormatter(year) {
      var remaining = parseInt(year / 12, 10);
    ...
    _createClass(View, [{
        ...
        value: function _getNavSwitchText(data) {
            ...
            if (this.model.state.viewMode == 'day') {
                output = this.model.options.dayPicker.titleFormatter.call(this, data.year + 1300, data.month);
                ...
                output = this.model.options.yearPicker.titleFormatter.call(this, data.year + 1300);
            }
            return output;
        }
