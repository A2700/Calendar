...
module.exports = {
    gregorian: {
        ...
        weekdaysMin: 'ی_د_س_چ_پ_آدینه_ش'.split('_')
    },
    persian: {
        months: ['فروردین', 'اردیبهشت', 'خرداد', 'تیر', 'مرداد', 'شهریور', 'مهر', 'آبان', 'آذر', 'دی', 'بهمن', 'اسفند'],
        monthsShort: ['فرو', 'ارد', 'خرد', 'تیر', 'مرد', 'شهر', 'مهر', 'آبا', 'آذر', 'دی', 'بهم', 'اسف'],
        weekdays: ['شنبه', 'یکشنبه', 'دوشنبه', 'سه شنبه', 'چهار شنبه', '\u067E\u0646\u062C\u200C\u0634\u0646\u0628\u0647', 'آدینه'],
        weekdaysShort: ['ش', 'ی', 'د', 'س', 'چ', 'پ', 'آدینه'],
        weekdaysMin: ['ش', 'ی', 'د', 'س', 'چ', 'پ', 'آدینه'],
